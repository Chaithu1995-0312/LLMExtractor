...
class AuditEventType(str, Enum):
    ...
    # --- COVERAGE ALERTS ---
    COVERAGE_ALERT_EMITTED = "COVERAGE_ALERT_EMITTED"
    COVERAGE_ALERT_SKIPPED_DUPLICATE = "COVERAGE_ALERT_SKIPPED_DUPLICATE"
    COVERAGE_ALERT_ACKNOWLEDGED = "COVERAGE_ALERT_ACKNOWLEDGED"
    COVERAGE_ALERT_DISMISSED = "COVERAGE_ALERT_DISMISSED"
    COVERAGE_ALERT_ACTION_TAKEN = "COVERAGE_ALERT_ACTION_TAKEN"
